...
import com.example.actor.services.ActorService;
...
public class ActorController {
  ...
  public String index(Model model,Pageable pageable) {
    ...
    Page<Actor> actorPage = actorService.getAllActor(pageable);
    PageWrapper<Actor> page = new PageWrapper<Actor>(actorPage, "/actor");
